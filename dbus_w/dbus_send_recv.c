...
void query(char* param)
{
   ...
   printf("Calling remote method with param \"%s\"\n", param);
   ...
   // loop, testing for new messages
    while (true) {
      ...
      if (dbus_message_is_method_call(msg, "test.method.Type", "Method"))
          ...
          printf("msg is not method call, continue to read\n");  // Add by WHT 20220119
